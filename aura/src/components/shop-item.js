...
const ShopItem = ({ data, addToCart, cartItems, isFilterActive }) => {
    ...
    return (
        <>
            {Modal && (
                <>
                    <div className={`modal-active shop-styling overlay ${isFilterActive ? 'active' : ''}`} onClick={ToggleModal} />
                    <div className={`shop-styling pop-up ${isFilterActive ? 'active' : ''}`}>
